...
class CompanyReport(BaseModel):
    ...
    positive_factors: list[str] = Field(
        description="Только по явно релевантным новостям/профилю; пустой список допустим; без факторов из слабого keyword-match"
    )
    negative_factors: list[str] = Field(
        description="Только по явно релевантным новостям; пустой список допустим; не выдумывать из нерелевантных заголовков"
    )
